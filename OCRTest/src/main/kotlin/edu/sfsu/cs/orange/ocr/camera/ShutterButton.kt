...
class ShutterButton : ImageView {
    ...
    interface OnShutterButtonListener {
         ...
         */
        fun onShutterButtonFocus(b: ShutterButton, pressed: Boolean)

        fun onShutterButtonClick(b: ShutterButton)
    }
    ...
    private fun callShutterButtonFocus(pressed: Boolean) {
        if (mListener != null) {
